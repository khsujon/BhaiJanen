...
class ChatApplication:
    ...
    def _setup_main_window(self):
        self.window.title("Bhai Janen?")
        self.window.resizable(width=True, height=True)
        self.window.configure(width=690, height=690, bg=BG_COLOR)
        ...
        #text widget
        self.text_widget = Text(self.window, width=8, height=2, bg=BG_COLOR, fg=TEXT_COLOR, font=FONT_CODE, padx=5, pady=5)
